                ...
                <div class="h-100 d-flex flex-column justify-content-center bg-primary p-5">
                    ...
                    <div class="d-flex text-white">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">Ada banyak hal yang bisa dilakukan melalui aplikasi ini, seperti membuat program pembelajaran berbasis virtual. Berikutnya, ada LMS yang berisi laporan untuk program pembelajaran berbasis blended learning.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid py-0 px-5">
        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="blog-item">
                    <div class="position-relative overflow-hidden">
						<img src="<?php echo get_template_directory_uri().'/assets/img/image.jpg'; ?>" alt="" class="img-fluid" />
                    </div>
                    <div class="bg-secondary d-flex">
                        ...
                        <div class="d-flex flex-column justify-content-center py-3 px-4">
                            <div class="d-flex mb-2">
                                ...
                                <small class="text-uppercase me-3"><i class="bi bi-bookmarks me-2"></i>Workshop</small>
                            </div>
                            <a class="h4" href="<?php echo get_home_url() . '/detail/'; ?>">Pendampingan Internal IPD & IMD 2021</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="blog-item">
                    <div class="position-relative overflow-hidden">
						<img src="<?php echo get_template_directory_uri().'/assets/img/image1.jpg'; ?>" alt="" class="img-fluid" />
                    </div>
                    <div class="bg-secondary d-flex">
                        <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center bg-primary text-white px-4">
                            <span>10</span>
                        ...
                        <div class="d-flex flex-column justify-content-center py-3 px-4">
                            ...
                            <a class="h4" href="">Implementasi Pembelajaran Daring Dosen Telkom University</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="blog-item">
                    <div class="position-relative overflow-hidden">
						<img src="<?php echo get_template_directory_uri().'/assets/img/image2.jpg'; ?>" alt="" class="img-fluid" />
                    </div>
                    <div class="bg-secondary d-flex">
                        <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center bg-primary text-white px-4">
                            <span>25</span>
                        ...
                        <div class="d-flex flex-column justify-content-center py-3 px-4">
                            ...
                            <a class="h4" href="">Penyusunan Materi, Aktifitas LMS dan Sertifikasi CeLOE</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid bg-secondary px-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5" style="margin-top: 10px;">
                ...
                <p class="mb-4">Pada saat ini CeLOE sedang membuka lowongan Internship di bagian Pengembangan konten, syarat kualifikasinya mahasiswa aktif Telkom University yang mengambil mata kuliah magang/ kerja Profesi, dan memiliki sikap kerja yang baik, disiplin dan kreatif.</p>
                <form>
                    <div class="row gx-3">
                        <div class="col-6">
    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-0">
            <div class="col-lg-6" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img src="<?php echo get_template_directory_uri().'/assets/img/testimonial.jpg'; ?>" alt="" tyle="object-fit: cover;" class="position-absolute w-100 h-100" />
                </div>
            </div>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    ...
                    <div class="d-flex align-items-center">
                        <img src="<?php echo get_template_directory_uri().'/assets/img/testimonial-1.jpg'; ?>" alt="" class="img-fluid radius-image" />
                        <div class="ps-4">
                            <h3>Fegi Syawaldi</h3>
                ...
                <div class="testimonial-item">
                    <p class="fs-4 fw-normal mb-4"><i class="fa fa-quote-left text-primary me-3"></i>Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat dolor rebum sit ipsum.</p>
                    <div class="d-flex align-items-center">
                        <img src="<?php echo get_template_directory_uri().'/assets/img/testimonial-2.jpg'; ?>" alt="" class="img-fluid rounded-circle" />
                        <div class="ps-4">
                ...
                <div class="testimonial-item">
                    <p class="fs-4 fw-normal mb-4"><i class="fa fa-quote-left text-primary me-3"></i>Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat dolor rebum sit ipsum.</p>
                    <div class="d-flex align-items-center">
                        <img src="<?php echo get_template_directory_uri().'/assets/img/testimonial-3.jpg'; ?>" alt="" class="img-fluid rounded-circle" />
                        <div class="ps-4">
                ...
                <div class="testimonial-item">
                    <p class="fs-4 fw-normal mb-4"><i class="fa fa-quote-left text-primary me-3"></i>Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat dolor rebum sit ipsum.</p>
                    <div class="d-flex align-items-center">
                        <img src="<?php echo get_template_directory_uri().'/assets/img/testimonial-4.jpg'; ?>" alt="" class="img-fluid rounded-circle" />
